...
type MarkdownRemarkFrontmatterFieldSelector = {
  ...
  readonly description: InputMaybe<FieldSelectorEnum>;
  readonly descripton: InputMaybe<FieldSelectorEnum>;
  readonly dsq_thread_id: InputMaybe<FieldSelectorEnum>;
...
type MarkdownRemarkFrontmatterFilterInput = {
  ...
  readonly description: InputMaybe<StringQueryOperatorInput>;
  readonly descripton: InputMaybe<StringQueryOperatorInput>;
...
type MarkdownRemarkFrontmatterSortInput = {
  ...
  readonly description: InputMaybe<SortOrderEnum>;
  readonly descripton: InputMaybe<SortOrderEnum>;
  readonly dsq_thread_id: InputMaybe<SortOrderEnum>;
...
type IndexPageQuery = { readonly site: { readonly meta: { readonly title: string | null, readonly description: string | null, readonly siteUrl: string | null, readonly author: string | null, readonly twitter: string | null } | null } | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly remark: { readonly posts: ReadonlyArray<{ readonly post: { readonly frontmatter: { readonly layout: string | null, readonly title: string | null, readonly path: string | null, readonly category: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly description: string | null, readonly date: string | null } | null } }> } };
...
type PostByPathQuery = { readonly site: { readonly meta: { readonly title: string | null, readonly description: string | null, readonly siteUrl: string | null, readonly author: string | null, readonly twitter: string | null } | null } | null, readonly post: { readonly id: string, readonly html: string | null, readonly frontmatter: { readonly layout: string | null, readonly title: string | null, readonly path: string | null, readonly category: string | null, readonly tags: ReadonlyArray<string | null> | null, readonly description: string | null, readonly date: string | null, readonly image: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData, readonly original: { readonly src: string | null } | null } | null } | null } | null } | null };

type ProfilePageQueryVariables = Exact<{ [key: string]: never; }>;


type ProfilePageQuery = { readonly profile: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly kawaii: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly mockup1: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly mockup2: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly mockup3: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly work1: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null, readonly work2: { readonly childImageSharp: { readonly gatsbyImageData: import('gatsby-plugin-image').IGatsbyImageData } | null } | null };
