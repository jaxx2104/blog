...
- 何歳から保育園行くべき
  - 0 歳児クラスがいちばん定員数としては多い
  - 1 歳児、2 歳児、3 歳児と持ち上がりなので定員数は減っていく
  - （個人的に）0 歳児で預けるのは良かった。人見知りしない、後追い少ない。
認可保育園
...
- 調整指数
  ...
  - 兄弟姉妹が認可保育園に通っている場合も加点だが 5 歳差で小学生ということで 0 点...
- 優先項目
...
- 保育園落ちないために
  - まずは
    ...
    - 自分たちが何点か計算しておくこと、無駄に取りこぼさないよう周囲の点数は X などで検索すると良い
- 振り返り
  - KEEP
    - 待機児童が少ない地域
    - 0 歳児から預ける
  - PROBREM
    - 上の子が小学校入学のタイミングで引っ越したが、保育園は待機児童多かったし、5 歳差や隣接する市からの転入で点数的に不利だった
    - でもこんな事を考えなくても子育てと仕事を両立できる環境が一番良い
  - TRY
    - このドキュメントを残す
